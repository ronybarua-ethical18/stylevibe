export const SERVICE_CATEGORIES = [
  { value: 'Beard and Hair Services', label: 'Beard and Hair Services' },
...
export const SERVICE_SUB_CATEGORIES = [
  ...
  { value: 'Neck Shave', label: 'Neck Shave' },
  { value: 'Shave & Facial', label: 'Shave & Facial' },
  { value: 'Facial Makeup', label: 'Facial Makeup' },
